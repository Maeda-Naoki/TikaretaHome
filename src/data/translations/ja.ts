export const ja = {
  ...
  pricingSummary: {
    title: '料金プラン',
    subtitle: 'おさんぽ記録は無料でスタート。もっと深く知りたい方にはStandardプラン・Proプランを。',
    cta: '詳しく見る',
    billingLabel: '請求サイクル',
    billingMonthly: '月払い',
    billingYearly: '年払い',
  ...
  walkingTypes: {
    shadeHunter: {
      name: '日陰ハンター型',
      description: '暑さを避けて木陰を求める慎重派',
    },
    explorer: {
      name: '探検家型',
      description: '新しい道を開拓するのが大好き',
    },
    morningEnjoyer: {
      name: '朝型エンジョイ派',
      description: '朝の散歩を最も楽しむタイプ',
    },
    shortBurst: {
      name: 'ショートバースト型',
      description: '短時間で集中的に散歩するタイプ',
    },
    socialButterfly: {
      name: 'ソーシャル型',
      description: '他の犬との交流が大好き',
    },
    steadyWalker: {
      name: '定番ルート型',
      description: 'いつものコースを安心して歩く',
    },
    nightOwl: {
      name: '夜型散歩派',
      description: '夕方〜夜の散歩が多いタイプ',
    },
    weatherFlexible: {
      name: '天候フレキシブル型',
      description: '天気に左右されず散歩を楽しむ',
    },
  },
  // FAQ
  faq: {
    ...
    basic: {
      ...
      howToStart: {
        question: 'どうやって始めるの？',
        answer:
          'トップページの「無料で始める」ボタンからアカウント登録（Googleアカウント）を行い、愛犬のプロフィールを登録するだけです。30秒で始められます。',
      },
      supportedDevices: {
        question: '対応しているスマホは？',
        answer:
          'iOS と Android のスマートフォンに対応しています。GPSでおさんぽを記録するため、スマートフォンでのご利用を推奨しています。',
      },
      deviceChange: {
        question: '機種変更してもデータは残る？',
        answer:
          'はい。データはクラウドに保存されているため、新しい端末で同じアカウントにログインしていただければ、愛犬のプロフィールやおさんぽ記録をそのまま引き継げます。',
      },
      batteryUsage: {
    ...
    diagnosis: {
      ...
      typeChange: {
        question: 'タイプは変わる？',
        answer:
          'はい、散歩パターンが変化すると、タイプも更新されます。季節や愛犬の成長によって変化を楽しめます。',
      },
    },
    pricing: {
      freeFeatures: {
      ...
      paymentMethods: {
        question: '支払い方法は？',
        answer: 'クレジットカード（Stripe経由）でのお支払いに対応しています。',
      },
    },
    privacy: {
      locationPrivacy: {
      ...
      accountDeletion: {
        question: '退会（アカウント削除）したいときは？',
        answer:
          'アプリ内の設定画面からいつでも退会できます。退会時にはアカウント情報・愛犬のプロフィール・おさんぽ記録などが削除され、元に戻すことはできませんのでご注意ください。',
      },
      dataHandling: {
        question: '個人情報の取り扱いは？',
        answer:
          'プライバシーポリシーに基づき、適切に管理しています。詳細は「プライバシーポリシー」ページをご覧ください。',
      },
    },
  },
  // ロードマップ
  ...
  pages: {
    ...
    pricing: {
      ...
      description:
        'Freeプランから月額300円のStandardプラン、月額500円のProプランまで。おさんぽ記録は全て無料、もっと深く知りたい方にはStandardプラン・Proプランを。',
    },
    faq: {
