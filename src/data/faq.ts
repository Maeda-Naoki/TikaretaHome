...
export const faqItems: FAQItem[] = [
  ...
  },
  {
    ...
    questionKey: 'faq.basic.supportedDevices.question',
    answerKey: 'faq.basic.supportedDevices.answer',
    category: 'basic',
  },
  {
    id: 'device-change',
    questionKey: 'faq.basic.deviceChange.question',
    answerKey: 'faq.basic.deviceChange.answer',
    category: 'basic',
  },
  {
    id: 'battery-usage',
  ...
  {
    id: 'account-deletion',
    questionKey: 'faq.privacy.accountDeletion.question',
    answerKey: 'faq.privacy.accountDeletion.answer',
    category: 'privacy',
  },
  {
    id: 'data-handling',
